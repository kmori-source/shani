...
def make_evaluator():
    agents = {"network-agent/v1": AgentIdentity(
        agent_id="network-agent/v1", granted_dsal=3,
...
def run():
    ...
    ev = make_evaluator()
    good_ev = [EvidenceItem(source="siem", content="scan detected", confidence=0.92),
